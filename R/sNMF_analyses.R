...
##    The following code runs the sNMF analyses. There are two sets of analyses that were run in sNMF:
...
ksmo_alt_lfmm <- 
  LEA::vcf2lfmm(input.file = "1_Bioinformatics/iPyrad_output_files/n90_ksmo_alterna/ksmo_alterna_noMD.vcf", 
         output.file = "3_Analyses/2_Population_genetic_structure/sNMF_input_files/lampro_ksmo_alterna.lfmm", 
         force = TRUE)

ksmo_lfmm <- 
  LEA::vcf2lfmm(input.file = "1_Bioinformatics/iPyrad_output_files/n85_ksmo_transect/lampro_ksmo.vcf", 
           output.file = "3_Analyses/2_Population_genetic_structure/sNMF_input_files/lampro_ksmo.lfmm",
           force = TRUE)
...
lampro_snmf_ksmo_alt_5runs = snmf("3_Analyses/2_Population_genetic_structure/sNMF_input_files/lampro_ksmo_alterna.lfmm",
...
lampro_snmf_ksmo_5runs = snmf("3_Analyses/2_Population_genetic_structure/sNMF_input_files/lampro_ksmo.lfmm",
                            iterations=10000, K=1:10, rep=5,
                            entropy=T, CPU=8, ploidy=2) # rep is no. of runs for each value of K
...
lampro_snmf_ksmo_5runs <- load.snmfProject("3_Analyses/2_Population_genetic_structure/sNMF_input_files/lampro_ksmo.snmfProject")
lampro_snmf_ksmoalt_5runs <- load.snmfProject("3_Analyses/2_Population_genetic_structure/sNMF_input_files/lampro_ksmo_alterna.snmfProject")
